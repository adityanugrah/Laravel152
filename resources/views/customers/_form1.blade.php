<div class="form-group {{$errors->has('CustomerID')?'has-error has-feedback' : ''}}">
    ...
    <div class="col-md-4">
        <input type="text" class="form-control" id="CustomerID" name="CustomerID" value="{{ old('CustomerID') ? old('CustomerID'):(isset($customers->CustomerID) ? $customers->CustomerID : '') }}" disabled>
